...
// OPTIONS - PLEASE CONFIGURE THESE BEFORE USE!
	...
	$yourEmail = "webmaster@parroquiasjc.org"; // the email address you wish to receive these mails through
	$yourWebsite = "Mobile App - Parroquia San Juan de la Cruz"; // the name of your website
